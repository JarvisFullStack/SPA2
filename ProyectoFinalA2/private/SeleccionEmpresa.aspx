<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SeleccionEmpresa.aspx.cs" Inherits="ProyectoFinalA2.Registros.SeleccionEmpresa" %>
    ...
    <div class="row">
      <div class="col-lg-10 col-xl-9 mx-auto">
        <div class="card card-signin flex-row my-5">
          ...
          <div class="card-body">
            <h5 class="card-title text-center">Seleccion de Empresa</h5>
